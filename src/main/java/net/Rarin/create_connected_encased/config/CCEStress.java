...
public class CCEStress extends ConfigBase {
	...
	private static void assertFromCCE(BlockBuilder<?, ?> builder) {
		if (!builder.getOwner().getModid().equals(CCEncased.ID)) {
			throw new IllegalStateException("Non-Create Encased blocks cannot be added to Create Encased config.");
		}
	}
